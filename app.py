...
st.markdown(
    ...
    <style>
        ...
        [data-testid="stSidebar"] [data-testid="stNumberInput"] div:has(> input) {{
        ...
        [data-testid="stSidebar"] [data-testid="stNumberInput"] [data-baseweb="input"] button,
        [data-testid="stSidebar"] [data-testid="stNumberInput"] [data-baseweb="input"] button:hover,
        [data-testid="stSidebar"] [data-testid="stNumberInput"] [data-baseweb="input"] button:focus,
        [data-testid="stSidebar"] [data-testid="stNumberInput"] [data-baseweb="input"] button:active,
        [data-testid="stSidebar"] [data-testid="stNumberInput"] [data-baseweb="input"] button:disabled {{
        ...
        [data-testid="stSidebar"] [data-testid="stNumberInput"] [data-baseweb="input"] button + button {{
            border-left: 1px solid rgba(255,254,251,.35) !important;
        }}
        [data-testid="stSidebar"] [data-testid="stNumberInput"] [data-baseweb="input"] button *,
        [data-testid="stSidebar"] [data-testid="stNumberInput"] [data-baseweb="input"] button:hover *,
        [data-testid="stSidebar"] [data-testid="stNumberInput"] [data-baseweb="input"] button:focus *,
        [data-testid="stSidebar"] [data-testid="stNumberInput"] [data-baseweb="input"] button:active *,
        [data-testid="stSidebar"] [data-testid="stNumberInput"] [data-baseweb="input"] button:disabled *,
        [data-testid="stSidebar"] [data-testid="stNumberInput"] [data-baseweb="input"] button svg,
        [data-testid="stSidebar"] [data-testid="stNumberInput"] [data-baseweb="input"] button svg path {{
            background: transparent !important;
            color: #FFFEFB !important;
        ...
        [data-testid="stNumberInput"][data-testid="stNumberInput"] button,
        [data-testid="stSidebar"][data-testid="stSidebar"]
        [data-testid="stNumberInput"][data-testid="stNumberInput"] button:hover,
        [data-testid="stSidebar"][data-testid="stSidebar"]
        [data-testid="stNumberInput"][data-testid="stNumberInput"] button:disabled {{
        ...
        [data-testid="stSidebar"][data-testid="stSidebar"]
        [data-testid="stNumberInput"][data-testid="stNumberInput"] button svg,
        [data-testid="stSidebar"][data-testid="stSidebar"]
        [data-testid="stNumberInput"][data-testid="stNumberInput"] button svg path {{
            color: #FFFEFB !important;
            fill: #FFFEFB !important;
            stroke: #FFFEFB !important;
            opacity: 1 !important;
        ...
        [data-testid="stSidebar"][data-testid="stSidebar"]
        [data-testid="stNumberInput"][data-testid="stNumberInput"] input,
        [data-testid="stSidebar"][data-testid="stSidebar"]
        [data-testid="stNumberInput"][data-testid="stNumberInput"] input:focus,
        [data-testid="stSidebar"][data-testid="stSidebar"]
        [data-testid="stNumberInput"][data-testid="stNumberInput"] input:focus-visible {{
            background: transparent !important;
            border: 0 !important;
            border-radius: 0 !important;
            box-shadow: none !important;

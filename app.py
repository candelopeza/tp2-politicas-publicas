...
st.markdown(
    ...
    <style>
        ...
        [data-testid="stSidebar"] [data-baseweb="input"] button:focus,
        [data-testid="stSidebar"] [data-baseweb="input"] button:active,
        [data-testid="stSidebar"] [data-baseweb="input"] button:disabled {{
        ...
        [data-testid="stSidebar"] [data-baseweb="input"] button + button {{
